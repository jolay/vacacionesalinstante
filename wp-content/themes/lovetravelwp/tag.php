...
<?php if(have_posts()) : ?>
	...
	<?php if (isset($smof_data['tag_headerpage'])) { ?>
		<?php if ($smof_data['tag_headerpage'] == 1): ?>
	...
	<section id="internalpage">
		...
		<div class="container clearfix">
			...
			<?php if ($smof_data['tag_stylemasonry'] == 1): ?>
				
				<?php include "include/archive-content-masonry.php"; ?>
				
			<?php elseif ( $smof_data['tag_blog_layout'] == 'archive_right_sidebar'): ?>
			...
			<?php elseif ($smof_data['tag_blog_layout'] == 'archive_left_sidebar'): ?>
			
				<div class="grid_4"><?php if ( ! dynamic_sidebar( 'Sidebar' ) ) : ?><?php endif; ?></div>
				<div class="grid_8"><?php include "include/archive-content.php"; ?></div>
			
			<?php elseif ($smof_data['tag_blog_layout'] == 'archive_fullwidth'): ?>			
